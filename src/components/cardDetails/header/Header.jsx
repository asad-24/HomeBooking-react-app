    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light py-4 shadow-lg ">
      <div className="container-fluid "> 
        ...
        <div className="d-flex roomDetail">
          ...
          <p className="mt-3 px-2">10 guests, 5 bedrooms, 7 beds, 2.5 baths</p>
        </div>
          <ul className="navbar-nav ml-auto ms-auto  d-flex justify-content-center align-items-center">
            ...
            <li className="nav-item">
              <button className="btn btn-outline-dark header-btn px-3 mx-md-3  my-md-3 text-sm ml-2" onClick={toggleNav}>
                Map
              </button>
            </li>
            <li className="nav-items d-lg-none">
              ...
              <p className="px-3">10 guests, 5 bedrooms, 7 beds, 2.5 baths</p>
            </li>
          </ul>
        </div>
      </div>
